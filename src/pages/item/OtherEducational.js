...
const OtherEducational = () =>{
    ...
    useEffect(() => {
        ...
        const getAllItems = async () => {
            const response = await getRequest("/items/subCategory/3");
...
<Container>
      ...
      <p class="text-center m3-5 mx-1 mx-md-4 mt-3 text-info" >Best Educational Books</p>
        <p class="text-center h2 fw-bold m3-5 mb-5 mx-1 mx-md-4 mt-3" style={{color:'#083A79'}}>Other Educational Books</p>
...
export default OtherEducational;